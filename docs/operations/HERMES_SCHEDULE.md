...
| `09:20` | LLM 盘前摘要 | LLM / Discord | 按 Discord Markdown 卡片输出系统与数据质量、今日动作、热点、候选池、持仓风险和今日纪律 |
...
| `15:55` | LLM 收盘复盘 | LLM / Discord | 按 Discord Markdown 卡片输出系统与数据质量、今日闭环、收盘热点、盘前与收盘对比、候选池变化和明日清单 |
